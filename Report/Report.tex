...
framework from Section~\ref{sec:implementation} on the GitHub commit comments 
...
accurate classifier for the dataset in 
...
latency. We ensure that the DAS-3, on which we perform our experiments, is not 
...
\begin{table}[h!]
  ...
  \begin{tabular}{l l l l l}
    ...
    \midrule
    Preprocessor           & 2 minutes & ---    & 22 hours    & 8 hours    \\
...
idling, networking latency and I/O latency are not counted toward the total
time. This can be seen in the baseline time of the preprocessor, which is idling
37.5\% of the time.
...
all eight worker nodes keep a model of the classifier in memory. We use 
