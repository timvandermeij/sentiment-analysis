...
makes the results of the sentiment analysis more specific and might increase
...
analysis on a data stream in realtime.

Finally, further research could go into a comparison with other classifiers,
such as neural networks, or into researching other interpretations of the
used classifiers, such as the out-of-bag error for the random forest
classifier.
