...
made in these experiments and make use of the components of our framework for
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{0.66\textwidth}
    ...
    \caption{Cross-validation results for the passive aggressive classifier.}
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}{0.66\textwidth}
    ...
    \caption{Cross-validation results for the random forest classifier.}
